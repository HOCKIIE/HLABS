                        ...
                        <ol className="relative border-s border-gray-200 dark:border-gray-700">                  
                            <li className="mb-10 ms-4">
                                ...
                                <ul>
                                    ...
                                    <li className="text-lg leading-8 font-narmal text-gray-500 dark:text-gray-400">- Collaborate with UI/UX team</li>
                                    <li className="text-lg leading-8 font-narmal text-gray-500 dark:text-gray-400">- <strong>For Customer</strong> Develop the website according from requirement and template.</li>
                                    <li className="text-lg leading-8 font-narmal text-gray-500 dark:text-gray-400">- Develop Frontend and back-end website with Laravel framework v8.x</li>
                                    <li className="text-lg leading-8 font-narmal text-gray-500 dark:text-gray-400">- Develop UX/UI with Bootstrap v5</li>
                                    <li className="text-lg leading-8 font-narmal text-gray-500 dark:text-gray-400">- Develop Frontend website with React.js served by Express.js (and add TypeScript)</li>
                                    <li className="text-lg leading-8 font-narmal text-gray-500 dark:text-gray-400">- Develop Backend website with Node.js + Express.js + MongoDB</li>
                                    <li className="text-lg leading-8 font-narmal text-gray-500 dark:text-gray-400">- Develop UX/UI with Tailwind CSS + Ant</li>
                                    <li className="text-lg leading-8 font-narmal text-gray-500 dark:text-gray-400">- Create and develop text editor that can generate HTML based on Tailwind CSS formatting to support another of devices</li>
                                </ul>
