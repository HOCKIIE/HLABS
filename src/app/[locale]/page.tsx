    ...
    <>
      <div className="bg-dotted relative">
        <div className="container">
          <div className="grid grid-cols-12 gap-8 py-40">
            <div className="col-span-12 md:col-span-8">
              ...
              <p className="text-xl md:text-[24px] mt-6 text-slate-800 dark:text-slate-300 font-roboto-mono tracking-tight">&lt;I&apos;m Full Stack Developer for over 6 years live in Bangkok/&gt;</p>
