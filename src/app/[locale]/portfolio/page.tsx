...
export default function Experience(){
    const items = [{
        ...
        "description":"",
        "hashtag":['React.js','Next.js','Tailwind Css','Node.js','Express.js','MongoDB']
    },{
        "title":"Abilmente",
        "image":"/image/portfolio/abilmente.com.png",
        "url":'https://abilmente.com',
        "description":"Interior Design",
        "hashtag":['PHP','Laravel','Bootstrap','MySQL']
    },{
        "title":"Thai Print",
        ...
        "description":"",
        "hashtag":['Node.js','Express.js','MongoDB','React.js','Next.js','Tailwind Css','Swiper']
    },{
        ...
        "hashtag":['Node.js','Express.js','MongoDB','React.js','Next.js','Tailwind Css']
    },{
        "title":"Siam Nistrans",
                        ...
                        <div className="overflow-hidden p-1 bg-gray-300 dark:bg-slate-900 h-full border dark:border-gray-800 rounded-xl">
                            ...
                            <div className="bg-white/30 dark:bg-slate-800 rounded-lg p-2 min-h-[calc(100%-25px)]">
                                <code className="with-line-numbers text-sm">
                                    <div className="ms-10">
                                        <div className="line"><span className="text-gray-500">&lt;</span><span className="text-sky-600">div</span> <span className="text-sky-300">class</span><span className="text-gray-500">="</span><span className="text-orange-400">grid grid-cols-12</span><span className="text-gray-500">"&gt;</span></div>
                                        <div className="ms-[1.5rem] ">
                                            <div className="line"><span className="text-gray-500">&lt;</span><span className="text-sky-600">div</span> <span className="text-sky-300">class</span><span className="text-gray-500">="</span><span className="text-orange-400">col-span-12 md:col-span-4 xl:col-span-4 m-2</span><span className="text-gray-500">"&gt;</span></div>
                                            <div className="ms-[1.5rem] ">
                                                <div className="line"><span className="text-gray-500">&lt;</span><span className="text-sky-600">div</span> <span className="text-sky-300">class</span><span className="text-gray-500">="</span><span className="text-orange-400">p-1 bg-gray-300 dark:bg-slate-900 h-full border dark:border-gray-800 rounded-xl</span><span className="text-gray-500">"&gt;</span></div>
                                                <div className="ms-[1.5rem] ">
                                                    <div className="line"><span className="text-gray-500">&lt;</span><span className="text-sky-600">div</span> <span className="text-sky-300">class</span><span className="text-gray-500">="</span><span className="text-orange-400">tools ms-1 mt-1 mb-2 flex gap-2</span><span className="text-gray-500">"&gt;</span></div>
                                                    <div className="ms-[1.5rem]">
                                                        <div className="line"><span className="text-gray-500">&lt;</span><span className="text-sky-600">div</span>  <span className="text-sky-300">class</span><span className="text-gray-500">="</span><span className="text-orange-400">w-3 h-3 bg-red-500/20 dark:bg-red-500/20 rounded-full</span><span className="text-gray-500">"&gt;</span></div>
                                                        <div className="line"><span className="text-gray-500">&lt;</span><span className="text-sky-600">div</span>  <span className="text-sky-300">class</span><span className="text-gray-500">="</span><span className="text-orange-400">w-3 h-3 bg-yellow-500/20 dark:bg-yellow-500/20 rounded-full</span><span className="text-gray-500">"&gt;</span></div>
                                                        <div className="line"><span className="text-gray-500">&lt;</span><span className="text-sky-600">div</span>  <span className="text-sky-300">class</span><span className="text-gray-500">="</span><span className="text-orange-400">w-3 h-3 bg-green-500/20 dark:bg-green-500/20 rounded-full</span><span className="text-gray-500">"&gt;</span></div>
                                                    </div>
                                                    <div className="line"><span className="text-gray-500">&lt;/</span><span className="text-sky-600">div</span><span className="text-gray-500">&gt;</span></div>
                                                </div>
                                                <div className="ms-[1.5rem]">
                                                <div className="line"><span className="text-gray-500">&lt;</span><span className="text-sky-600">div</span> <span className="text-sky-300">class</span><span className="text-gray-500">="</span><span className="text-orange-400">bg-white/30 dark:bg-slate-800 rounded-lg p-2 h-auto</span><span className="text-gray-500">"&gt;</span><span className="text-gray-500">&lt;/</span><span className="text-sky-600">div</span><span className="text-gray-500">&gt;</span></div>
                                                </div>
                                                <div className="line"><span className="text-gray-500">&lt;/</span><span className="text-sky-600">div</span><span className="text-gray-500">&gt;</span></div>
                                            </div>
                                            <div className="line"><span className="text-gray-500">&lt;/</span><span className="text-sky-600">div</span><span className="text-gray-500">&gt;</span></div>
