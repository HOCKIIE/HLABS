      ...
      <div className="container">
        <div className="grid grid-cols-12 gap-8 mt-40">
          <div className="col-span-12 md:col-span-8">
            <h2 className="text-6xl md:text-9xl -tracking-tighter font-bold text-slate-800 dark:text-slate-300">Hi, I'm</h2>
            <h1 className="text-5xl md:text-8xl -tracking-tighter uppercase font-bold text-blue-800 dark:text-blue-700 mt-6" style={{lineHeight:'1.2'}}>suphawat kongson</h1>
