...
export default function Portfolio()
{
    ...
    <section className="portfolio overflow-x-hidden">
        <div className="container">
            <div className="v-line inset-s-0 -ms-6 col-start-1 row-span-full row-start-1 hidden md:block border-x border-black/10 dark:border-white/10 h-full absolute w-10 bg-[image:repeating-linear-gradient(315deg,_rgba(0,0,0,0.1)_0,_rgba(0,0,0,.1)_1px,_transparent_0,_transparent_50%)] dark:bg-[image:repeating-linear-gradient(315deg,_rgba(255,255,255,0.1)_0,_rgba(255,255,255,.1)_1px,_transparent_0,_transparent_50%)] bg-[size:10px_10px]"></div>
            <div className="grid">
                <div className="pt-20 md:pt-40 mb-4"></div>
                <span className="block ms-1 mb-1.25 text-black/10 dark:text-slate-700 font-roboto-mono text-xs">text-6xl mb-6 text-gray-800</span>
                ...
                <span className="block ms-1 mb-1.25 text-black/10 dark:text-slate-700 font-roboto-mono text-xs">grid grid-cols-12 gap-6 pt-4</span>
                        ...
                        <div className="col-span-12 md:col-span-4 xl:col-span-4 m-2" key={k}>
                            <div className="overflow-hidden p-1 bg-gray-300 dark:bg-slate-900 h-full border dark:border-gray-800 rounded-xl">
                                ...
                                <div className="bg-white/30 dark:bg-slate-800 rounded-lg p-2 h-auto">
                                    ...
                                    <div className="hashtag flex flex-wrap gap-2 my-2 h-10">{v.hashtag.map((v2,k2)=><div key={k2} className="text-indigo-500 dark:text-emerald-600 text-xs rounded-full">#{v2}</div>)}</div>
                                </div>
                            </div>
                        </div>
                    )}
            ...
            <div className="v-line inset-e-0 top-0 -me-6 row-span-full row-start-1 hidden md:block border-x border-black/10 dark:border-white/10 h-full absolute w-10 bg-[repeating-linear-gradient(315deg,rgba(0,0,0,0.1)_0,rgba(0,0,0,.1)_1px,transparent_0,transparent_50%)] dark:bg-[repeating-linear-gradient(315deg,rgba(255,255,255,0.1)_0,rgba(255,255,255,.1)_1px,transparent_0,transparent_50%)] bg-size[10px_10px]"></div>
        </div>
    </section>
    </>);
}