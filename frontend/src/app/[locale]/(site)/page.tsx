            ...
            <div className="bg-dotted relative">
                ...
                <div className="grid grid-cols-12 gap-8 py-40 select-none">
                    <div className="col-span-12 md:col-span-8">
                        <h2 className="text-6xl md:text-7xl xl:text-9xl -tracking-tighter font-bold text-slate-800 dark:text-slate-300 -top-20">Hi, I&apos;m</h2>
                        <h1 className="text-5xl md:text-6xl xl:text-8xl -tracking-tighter uppercase font-bold mt-6 bg-gradient-to-r from-indigo-500 to-pink-500 dark:from-emerald-500 dark:to-orange-500 bg-clip-text text-transparent">suphawat kongson</h1>
