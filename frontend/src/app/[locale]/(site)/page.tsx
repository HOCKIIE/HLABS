...
export default function Page() {
    ...
    const DownloadResume = () => {
        ...
        const uri_prefix = env === 'production' ? process.env.NEXT_PUBLIC_URI_PREFIX_PROD : process.env.NEXT_PUBLIC_URI_PREFIX_DEV;
        window.open(`${uri_prefix}/download/RESUME - Suphawat Kongson.pdf`, '_blank');
    }
    useEffect(() => {
            ...
            <div className="bg-dotted relative">
                ...
                <div className="grid grid-cols-12 gap-8 py-40 select-none">
                    <div className="col-span-12 md:col-span-8">
                        <h2 className="text-6xl md:text-7xl xl:text-9xl tracking-wider font-bold text-slate-800 dark:text-slate-300 -top-20">Hi, I&apos;m</h2>
                        <h1 className="text-5xl md:text-6xl xl:text-8xl tracking-wider uppercase font-bold mt-6 bg-linear-to-r from-indigo-500 to-pink-500 dark:from-emerald-500 dark:to-orange-500 bg-clip-text text-transparent">suphawat kongson</h1>
                        ...
                        <div className="flex gap-2 pt-10">
                            <button type="button" className="h-11 px-5 border rounded-full text-indigo-500 border-indigo-600 hover:bg-indigo-500 hover:text-gray-200 dark:border-emerald-500 dark:text-emerald-500 dark:hover:bg-emerald-500 dark:hover:text-gray-200 transition-all duration-500 flex items-center" onClick={DownloadResume}>Download Resume <FiDownload className="ms-2"/></button>
                            <button type="button" className="w-11 h-11 border rounded-full text-indigo-500 border-indigo-600 hover:bg-indigo-500 hover:text-gray-200 dark:border-emerald-500 dark:text-emerald-500 dark:hover:bg-emerald-500 dark:hover:text-gray-200 transition-all duration-500 flex items-center justify-center" title="GitHub"><FaGithub fontSize={'20px'}/></button>
