                    ...
                    <form className="w-full">   
                        ...
                        <div className="relative">
                            ...
                            <button 
                                ...
                                type="button"
                                onSelect={()=>true}
                                className="text-gray-300 absolute end-2.5 bottom-2.5 bg-blue-300 hover:bg-blue-400 rounded-lg text-xs px-2 py-1 dark:bg-blue-800 dark:hover:bg-blue-900"
                            >esc</button>
                        </div>
                    </form>
                </div>
