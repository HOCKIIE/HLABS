...
interface IconProps { type: IconType; s:string | number; c:string;}
...
export const SkillCard = ({
    ...
    return (
        <div className="card-item col-span-6 md:col-span-3 xl:col-span-2">
            <div className="rounded-3xl shadow-xl overflow-hidden relative p-6 min-h-60 bg-slate-100 dark:bg-slate-900 dark:hover:bg-linear-to-br dark:hover:from-emerald-900 dark:hover:via-slate-900 dark:hover:to-slate-900 transition-all duration-500 hover:bg-indigo-200">
                ...
                <div className="flex items-center justify-center z-20">
                    {loading && 
                        <div>
                            ...
                            <div className="w-25 h-25 rounded-full bg-slate-300 animate-pulse mt-6" />
                        </div>
                    }
...
export const ToolsCard = ({
    ...
    return (
        <div className="card-item col-span-6 md:col-span-3 xl:col-span-2">
            <div className="rounded-3xl min-h-60 shadow-md p-6 bg-slate-100 dark:bg-slate-900 hover:dark:bg-slate-800 transition-all duration-500 hover:bg-indigo-100 hover:transform hover:rotate-3">
