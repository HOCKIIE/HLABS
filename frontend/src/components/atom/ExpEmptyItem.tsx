...
const ExpEmptyItem = () => {
    ...
    <div className='grid pb-20 ms-1'>
        <div className={`absulute flex items-center justify-center w-6 h-6 rounded-full -ms-4.5 transition-all duration-500 delay-900 ring-8 ring-gray-200 dark:ring-slate-800 bg-gray-400 dark:bg-gray-400 z-100 overflow-hidden`}>
        ...
        <div className="ms-5 mt-[-1.7rem] flex">
            <div className="rounded-lg bg-gray-100 dark:bg-slate-900 animate-pulse overflow-hidden shadow pe-2 relative">
                ...
                <div className="py-3">
                    <div className="relative z-3 flex w-100">
                        ...
                        <div className="mx-4 w-full">
                            ...
                            <div className="flex items-end w-20 mt-2">
                                <div className="w-full h-5 rounded-lg bg-slate-300 animate-pulse" />
                            </div>
                        </div>
                    </div>
        ...
        <div className="ms-4 w-75 flex my-5">
            <div className="w-full h-5 rounded-lg bg-slate-300 animate-pulse" />
        </div>
